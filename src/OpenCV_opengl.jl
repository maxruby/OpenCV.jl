...
oglBuffer(arows::Int, acols::Int, atype::Int, abufId::UInt, autoRelease = false) = @cxx cv::ogl::Buffer::Buffer(arows, acols, atype, abufId, autoRelease)

# using size::cvSize (2D array size)
oglBuffer(size, atype::Int, abufId::UInt, autoRelease = false) = @cxx cv::ogl::Buffer::Buffer(size, atype, abufId, autoRelease)
